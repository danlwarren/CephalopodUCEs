seed = -1
seqfile = dating.dummy.phy  * A dummy alignment only allow to run MCMCtree
treefile = dating.rooted.nwk  * Rooted newick tree with annotated fossil/tip dates
mcmcfile = dating.mcmctree.log  * MCMC log of parameters that can be examined in Tracer
outfile = dating.mcmctree.out  * Output of the summerized results of MCMCtree
ckpfile = dating.mcmctree.ckp  * Checkpoint file of MCMCtree
hessianfile = dating.mcmctree.hessian  * File with gradient and hessian matrix
